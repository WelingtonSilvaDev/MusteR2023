...
if (0){
  ...
  iref = c(1,1,2,1,rep(3:4,length(pdb)))
...
if(1){
  ...
  seq.id = c(6,8)
  seq.id = c(8)
  m.inosfac.cry = consolidate_res_table(dba2,seq.id,noid=c("HCC","HCO","HCR","HFN"))
  seq.id = c(seq(10,by=4,32))
  seq.id = c(20)
  m.inosfac.lig = consolidate_res_table(dba2,seq.id,noid=c("HCC","HCO","HCR","HFN"))
  #seq.id = c(2,4)
...
if(1){
  ...
  p.inosfac.cry = plot_lig_res_interactions(m.inosfac.cry,scene="scene1",area.lim=100,alpha=0.1,n=800)
  p.inosfac.lig = plot_lig_res_interactions(m.inosfac.lig,scene="scene2",area.lim=100,alpha=0.1,n=800)
  #p.inosfac.cry24 = plot_lig_res_interactions(m.inosfac.cry24,scene="scene3",area.lim=100,alpha=0.1,n=800)
  p.all = subplot(p.inosfac.cry,p.inosfac.lig);print(p.all)
  #print(p.all)
  #print(p.inosfac.cry)
  dba2.size = object.size(dba2)
