...
plot_g = function(parg,limxyz,title="1o",col=NULL,sub="",dx=1.1){
...
vertex.size=size,edge.width=ewidth,edge.color=ecolor,edge.label=elabel,layout=coordi,vertex.label.color="black",main=m$n,xlim=xlim,ylim=ylim,rescale=F,axes=T)#;readline()
